...
const Presentation = () => {
  return (
    <div className='bg-primary md:pt-[2rem] pt-[5rem] flex md:flex-col justify-between' id='Introduction'>
      ...
      justify-start md:items-center xl:items-center gap-[1rem]">
        ...
        <div className="flex ss:flex-col-reverse gap-4 m-t-[1rem] items-center">
          <button className='whiteButton'>Booking Now</button>
          <a href='#cars'>See all cars</a>
        </div>
      </div>
      <div className=" flex-[1] min-w-[50%] md:h-[300px] h-[680px]">
